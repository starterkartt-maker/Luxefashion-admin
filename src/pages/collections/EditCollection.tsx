...
export default function EditCollection() {
  ...
  const uploadImage = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      toast.success("Image uploaded temporarily. Save collection to persist.");
    } catch (e: any) {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 pb-20 font-sans text-gray-900 dark:text-zinc-50">
      ...
      <div className="bg-white dark:bg-zinc-900 p-6 border border-gray-200 dark:border-zinc-800 rounded-xl shadow-xs space-y-6">
        <div className="space-y-4">
          <div className="space-y-2">
            <Label className="text-gray-700 dark:text-zinc-300">Collection Name</Label>
          ...
          <div className="space-y-2">
            <Label className="text-gray-700 dark:text-zinc-300">Description</Label>
            <Textarea {...register("description")} className="min-h-[100px] dark:bg-zinc-850 dark:border-zinc-800" />
          </div>
          ...
          <div className="flex items-center space-x-2 pt-2">
            ...
            />
            <Label htmlFor="active" className="cursor-pointer text-gray-700 dark:text-zinc-300">
              Active Collection
            </Label>
          </div>
        </div>
        ...
        <div className="space-y-4 pt-6 border-t border-gray-150 dark:border-zinc-800">
          <Label className="text-gray-700 dark:text-zinc-300">Collection Image</Label>
          <div className="flex items-start gap-6">
            {image ? (
              ...
              <div className="w-40 h-40 border-2 border-dashed border-gray-250 dark:border-zinc-800 rounded-lg flex flex-col items-center justify-center text-muted-foreground dark:text-zinc-500 bg-gray-50/50 dark:bg-zinc-950/20">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground dark:text-zinc-500 mt-2 max-w-[200px]">
                Recommended size: 1024x1024px. Will be used as the collection
                cover.
              </p>
            </div>
          </div>
        ...
        {!isNew && (
          <div className="pt-6 border-t border-gray-150 dark:border-zinc-800">
            <HomepageSectionSelector itemId={id} type="collections" />
          </div>
        )}
        ...
        {isNew && (
          <div className="pt-6 border-t border-gray-150 dark:border-zinc-800 p-4 rounded-xl bg-amber-50/20 border border-amber-900/10">
            ...
            <p className="text-xs text-muted-foreground dark:text-zinc-400">
              Save this collection first to enable adding it directly to your Home Screen sections!
            </p>
          </div>
        )}
